...
function alterPrice(mpriceID) {
	...
	$('#manager-dynamic-2').html('<input type="number" name="new_price" placeholder="New price for Standard VND"><button onclick="changePrice()">Change</button>');
}
