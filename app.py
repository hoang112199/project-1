...
def verifyAndRenderRespective():
    ...
    try:
        ...
        if username == '1' and password == '1':
            ...
            res = runQuery(
                "SELECT ma_nhan_vien,ten_nhan_vien,can_cuoc_cong_dan,chuc_vu FROM nhan_vien WHERE ten_nhan_vien = '"+username+"' and can_cuoc_cong_dan = '"+password+"'")
...
def createBooking():
    ...
    res = runQuery(
        "INSERT INTO new_booked_tickets VALUE("
        +str(ticketNo)+","
        +showID+","
        +str(seatNo)+","
        +staffID+")"
